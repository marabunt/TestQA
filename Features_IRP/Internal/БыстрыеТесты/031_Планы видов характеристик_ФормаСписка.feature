...
Сценарий: Открытие формы списка плана видов характеристик "Типы дополнительных реквизитов и сведений"
...
Сценарий: Открытие формы списка плана видов характеристик "Пользовательские настройки"
...
Сценарий: Открытие формы списка плана видов характеристик "Вид контактной информации"
...
Сценарий: Открытие формы списка плана видов характеристик "Виды мультивалютной аналитики"
